...
class DocbookToXhtml5EditTest extends BaseTest
{
    ...
    {
        return __DIR__ . '/../../../../../../src/lib/eZ/RichText/Resources/stylesheets/docbook/xhtml5/edit/xhtml5.xsl';
    }
    ...
    protected function getCustomConversionTransformationStylesheets()
    {
        return [
            [
                'path' => __DIR__ . '/../../../../../../src/lib/eZ/RichText/Resources/stylesheets/docbook/xhtml5/edit/core.xsl',
                'priority' => 100,
            ],
            [
